...
HEADERS_LIST = pipeline.h error.h
HEADERS = $(addprefix $(HEADERS_DIRECTORY), $(HEADERS_LIST))
INCLUDES = -I$(HEADERS_DIRECTORY) -I$(LIBFT_HEADER)

# Source Files (mandatory)
SOURCES_DIRECTORY = ./sources/mandatory/
SOURCES_LIST = pipeline.c ft_error_and_free.c ft_close_pipe.c ft_fork_process.c ft_execute_cmd.c
SOURCES = $(addprefix $(SOURCES_DIRECTORY), $(SOURCES_LIST))

# Source Files (bonus)
SOURCES_DIRECTORY_BONUS = ./sources/bonus/
SOURCES_LIST_BONUS = pipeline_bonus.c ft_error_and_free_bonus.c ft_close_pipe_bonus.c ft_fork_process_bonus.c ft_execute_cmd_bonus.c
